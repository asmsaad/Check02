...
class ViolationViewer:
    ...
    def __init__(self, root):
        ...
        # ---- Base Frame ----
        self.base_frame = ttk.Frame(root, style="TFrame")
    ...
    def _init_layout(self):
        ...
        # ---- Body Frames ----
        self.body_left = ttk.Frame(self.body_pane, width=200, style="Section.TFrame")
        self.body_right = ttk.Frame(self.body_pane, width=800, style="Section.TFrame")
        ...
        self.toggle_btn = ttk.Button(self.toolbar, text="Hide Panel", width=15, command=self.toggle_panel)
        self.toggle_btn.pack(side="left", padx=5, pady=5)

        self.move_btn = ttk.Button(self.toolbar, text="Move Panel Right", width=20, command=self.move_panel)
