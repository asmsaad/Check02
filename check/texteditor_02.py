...
class SyntaxHighlightingTextEditor:
    ...
    def setup_ui(self):
        ...
        ttk.Label(control_frame, text="Language:").grid(row=0, column=0, sticky='w', padx=(0, 5))
        ...
        ttk.Label(control_frame, text="Theme:").grid(row=0, column=1, sticky='w', padx=(0, 5))
        ...
        ttk.Label(bg_control_frame, text="Background:").grid(row=0, column=0, sticky='w')
    ...
    def setup_default_tags(self):
        ...
        default_tags = {
            ...
            'Token.Keyword': {'foreground': '#C586C0', 'font': ('Courier New', 12, 'bold')},
            'Token.Keyword.Constant': {'foreground': '#C586C0', 'font': ('Courier New', 12, 'bold')},
            'Token.Keyword.Declaration': {'foreground': '#C586C0', 'font': ('Courier New', 12, 'bold')},
            'Token.Keyword.Namespace': {'foreground': '#C586C0', 'font': ('Courier New', 12, 'bold')},
            'Token.Keyword.Pseudo': {'foreground': '#C586C0', 'font': ('Courier New', 12, 'bold')},
            'Token.Keyword.Reserved': {'foreground': '#C586C0', 'font': ('Courier New', 12, 'bold')},
            'Token.Keyword.Type': {'foreground': '#4EC9B0', 'font': ('Courier New', 12, 'bold')},
            ...
            'Token.Operator.Word': {'foreground': '#C586C0', 'font': ('Courier New', 12, 'bold')},
            ...
            'Token.Generic.Heading': {'foreground': '#000080', 'font': ('Courier New', 12, 'bold')},
            ...
            'Token.Generic.Subheading': {'foreground': '#800000', 'font': ('Courier New', 12, 'bold')},
    ...
    def on_bg_color_change(self, event):
        ...
        print(f"Changing background to: {selected_bg} -> {self.current_bg_color}")  # Debug
        self.apply_theme()
        self.highlight_syntax()
        ...
        try:
            ...
            for token_type, token_value in tokens:
                if token_value:  # Process all tokens including whitespace
                    end_index = self.text_area.index(f"{start_index}+{len(token_value)}c")
